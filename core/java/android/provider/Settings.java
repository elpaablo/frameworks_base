...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        static {
            ...
            PRIVATE_SETTINGS.add(SMART_CHARGING);
            PRIVATE_SETTINGS.add(SMART_CHARGING_LEVEL);
            PRIVATE_SETTINGS.add(SMART_CHARGING_RESUME_LEVEL);
            PRIVATE_SETTINGS.add(SMART_CUTOFF);
            PRIVATE_SETTINGS.add(SMART_CUTOFF_TEMPERATURE);
            PRIVATE_SETTINGS.add(SMART_CUTOFF_RESUME_TEMPERATURE);
        }
